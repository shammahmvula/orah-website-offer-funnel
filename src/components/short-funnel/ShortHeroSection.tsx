  ...
  return (
    <section className="min-h-screen pt-16 pb-12 px-4 flex flex-col justify-center bg-gradient-to-b from-background to-muted/30">
      <div className="max-w-lg mx-auto w-full">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="card-premium text-center mb-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.25 }} className="card-premium text-left mb-8 space-y-3">
          <p className="text-foreground font-semibold text-sm">Think about what R5,000 really costs you:</p>
          <p className="text-muted-foreground text-sm">If your business makes R50,000/month, that's <span className="text-foreground font-semibold">3 DAYS</span> of revenue.</p>
          <p className="text-muted-foreground text-sm">For a website that could bring you customers for the next <span className="text-foreground font-semibold">5–10 years</span>.</p>
          ...
          <p className="text-accent font-bold text-sm pt-2 border-t border-border">R5,000 once-off isn't an expense. It's the cheapest marketing asset you'll ever own.</p>
        </motion.div>
